//  eq_sub_super_anti_recognition - Classifies input patterns as either sub-pattern, super-pattern, equivalence or anti-pattern with respect to weights grid (v0.2)
